const data = `toggle 461,550 through 564,900
...
const splitArray = array.map((str) => {
  return str.split(" ");
});

const main = splitArray.map((array) => {
  if (array.length == 4) {
    return {
      action: array[0],
      start: array[1].split(","),
...
// // turnoff
// const turnOff = (rowStart, rowEnd, colStart, colEnd) => {
//   for (let row = parseInt(rowStart); row <= parseInt(rowEnd); row++) {
//     for (let col = parseInt(colStart); col <= parseInt(colEnd); col++) {
//       grid[row][col] = 0;
...
// // turnon
// const turnOn = (rowStart, rowEnd, colStart, colEnd) => {
//   for (let row = parseInt(rowStart); row <= parseInt(rowEnd); row++) {
//     for (let col = parseInt(colStart); col <= parseInt(colEnd); col++) {
//       grid[row][col] = 1;
//       // console.log(row, col, grid[row][col]);
...
// // toggle
// const toggle = (rowStart, rowEnd, colStart, colEnd) => {
//   for (let row = parseInt(rowStart); row <= parseInt(rowEnd); row++) {
//     for (let col = parseInt(colStart); col <= parseInt(colEnd); col++) {
//       if (grid[row][col] === 0) {
//         grid[row][col] = 1;
...
//     turnOn(obj["start"][0], obj["end"][0], obj["start"][1], obj["end"][1]);
//   }
//   if (obj["action"] === "turnoff") {
//     turnOff(obj["start"][0], obj["end"][0], obj["start"][1], obj["end"][1]);
//   }
//   if (obj["action"] === "toggle") {
//     toggle(obj["start"][0], obj["end"][0], obj["start"][1], obj["end"][1]);
//   }
// }
